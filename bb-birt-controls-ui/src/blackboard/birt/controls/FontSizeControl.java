...
public class FontSizeControl extends Composite
{
  ...
  {
    preValues = ChoiceSetFactory.getElementChoiceSet( ReportDesignConstants.STYLE_ELEMENT, StyleHandle.FONT_SIZE_PROP );
  ...
  protected void processAction()
  {
    ...
    {
      if ( isInPreIntTable( val ) )
        newValue = val + DEUtil.resolveNull( getUnitsValue( unitCombo.getText() ) );
      else
    ...
    if ( newValue == null ? fontSizeValue != null : !newValue.equals( fontSizeValue ) )
    {
