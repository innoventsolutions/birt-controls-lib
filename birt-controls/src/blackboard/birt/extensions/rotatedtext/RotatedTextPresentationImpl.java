...
public class RotatedTextPresentationImpl extends ReportItemPresentationBase
{
  ...
  public Object onRowSets( IBaseResultSet[] results ) throws BirtException
  {
    ...
    final BufferedImage rotatedImage = SwingGraphicsUtil.createRotatedTextImage( text, data, this.dpi, 1, "in" );
    ...
    return new Object[] { bis, createImageMap( url, text, rotatedImage.getWidth(), rotatedImage.getHeight() ) };
  }

  private String evaluate( final String expression, final IBaseResultSet[] results ) throws BirtException
  {
    String text = null;
  ...
  private String createImageMap( final String url, final String text, final int width, final int height )
  {
    ...
    sb.append( "</area>" );
    sb.append( "<script>" );
    sb.append( " var areaNode = document.getElementById(\"RotatedTextImageMapArea" + index + "\");" );
    sb.append( " if(areaNode != null)" );
    sb.append( " {" );
    sb.append( "   areaNode.setAttribute(\"alt\", \"" + text.replace( "\"", "'" ) + "\");" );
    sb.append( "   areaNode.setAttribute(\"title\", \"" + text.replace( "\"", "'" ) + "\");" );
