...
public class RotatedTextData
{
  ...
  public boolean equals( Object obj )
  {
    ...
    if ( this.wrapPoint != that.wrapPoint )
      return false;
    if ( this.fontFamily == null ? that.fontFamily != null : !this.fontFamily.equalsIgnoreCase( that.fontFamily ) )
      return false;
    if ( this.fontSize == null ? that.fontSize != null : !this.fontSize.equalsIgnoreCase( that.fontSize ) )
      return false;
    ...
    if ( this.fontColor == null ? that.fontColor != null : !this.fontColor.equals( that.fontColor ) )
      return false;
    if ( this.linkURL == null ? that.linkURL != null : !this.linkURL.equals( that.linkURL ) )
      return false;
    return true;
  }
}
