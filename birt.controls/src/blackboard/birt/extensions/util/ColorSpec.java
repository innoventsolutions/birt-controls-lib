...
public final class ColorSpec
{
  ...
  private static final Pattern shortHexPattern = Pattern.compile( "#([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])", 0 );
  private static final Pattern longHexPattern = Pattern.compile( "#([0-9A-Fa-f][0-9A-Fa-f])([0-9A-Fa-f][0-9A-Fa-f])([0-9A-Fa-f][0-9A-Fa-f])", 0 );
