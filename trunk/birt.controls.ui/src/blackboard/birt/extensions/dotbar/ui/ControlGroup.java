...
public class ControlGroup
{
  ...
  public void load( DotbarData config )
  {
    ...
    RGB borderRGB = new RGB( config.borderColor.r, config.borderColor.g, config.borderColor.b );
    this.borderColor.setRGB( borderRGB );
    this.hasFill.setSelection( config.hasFill );
    RGB fillRGB = new RGB( config.fillColor.r, config.fillColor.g, config.fillColor.b );
    ...
    RGB fontRGB = new RGB( config.fontColor.r, config.fontColor.g, config.fontColor.b );
  ...
  public void build( final Composite composite, final ControlEventHandler handler, final Color backgroundColor )
  {
    ...
    this.displayValue = createIntegerControl( composite, "Designer Display Value:", backgroundColor );
    this.orientation = createRadioGroup( composite, "Orientation:", new String[] { "Horizontal", "Vertical" }, backgroundColor );
    this.wrapPoint = createIntegerControl( composite, "Wrap Point:", backgroundColor );
    ...
    if ( handler != null )
    {
      ...
      addModifyListener( this.displayValue, handler, DotbarItem.DISPLAY_VALUE_PROP );
      addFocusListener( this.displayValue, handler, DotbarItem.DISPLAY_VALUE_PROP );
      ...
      addModifyListener( this.dotHeight, handler, DotbarItem.DOT_HEIGHT_PROP );
      addFocusListener( this.dotHeight, handler, DotbarItem.DOT_HEIGHT_PROP );
      addModifyListener( this.dotSpacing, handler, DotbarItem.DOT_SPACING_PROP );
      addFocusListener( this.dotSpacing, handler, DotbarItem.DOT_SPACING_PROP );
      addModifyListener( this.numberWidth, handler, DotbarItem.NUMBER_WIDTH_PROP );
      addFocusListener( this.numberWidth, handler, DotbarItem.NUMBER_WIDTH_PROP );
      addModifyListener( this.numberHeight, handler, DotbarItem.NUMBER_HEIGHT_PROP );
      addFocusListener( this.numberHeight, handler, DotbarItem.NUMBER_HEIGHT_PROP );
      addModifyListener( this.wrapPoint, handler, DotbarItem.WRAP_POINT_PROP );
      addFocusListener( this.wrapPoint, handler, DotbarItem.WRAP_POINT_PROP );
      setRadioListener( this.orientation, handler, DotbarItem.VERTICAL_PROP );
      setRadioListener( this.dotShape, handler, DotbarItem.DOT_SHAPE_PROP );
      setRadioListener( this.numberPosition, handler, DotbarItem.NUMBER_POSITION_PROP );
      addSelectionListener( this.hasBorder, handler, DotbarItem.HAS_BORDER_PROP );
      addFocusListener( this.hasBorder, handler, DotbarItem.HAS_BORDER_PROP );
      addSelectionListener( this.hasFill, handler, DotbarItem.HAS_FILL_PROP );
      ...
      addFocusListener( this.fontFamily, handler, DotbarItem.FONT_FAMILY_PROP );
      addSelectionListener( this.fontFamily, handler, DotbarItem.FONT_FAMILY_PROP );
  ...
  private void createNumberControls( Composite parent, Color backgroundColor )
  {
    ...
    this.numberPosition = createRadioGroup( group, "Position:", NumberPosition.getNames(), backgroundColor );
    {
      GridData gridData = new GridData();
      gridData.horizontalSpan = 3;
      this.numberPosition.setLayoutData( gridData );
    }
    this.numberWidth = createDimensionBuilder( group, "Width:", backgroundColor, DotbarItem.NUMBER_WIDTH_PROP );
    this.numberHeight = createDimensionBuilder( group, "Height:", backgroundColor, DotbarItem.NUMBER_HEIGHT_PROP );
    this.fontFamily = createFontFamilyControl( group, "Font:", backgroundColor );
    {
      GridData gridData = new GridData();
      gridData.horizontalSpan = 3;
    ...
    this.fontStyle = createFontStyleBuilder( group, "Style:", backgroundColor );
  ...
  private Combo createFontFamilyControl( Group group, String string, Color backgroundColor )
  {
  ...
  private FontStyleControl createFontStyleBuilder( Group group, String string, Color backgroundColor )
  {
    createLabel( group, string, backgroundColor );
  ...
  private FontSizeControl createFontSizeBuilder( Group group, String string, Color backgroundColor )
  {
    createLabel( group, string, backgroundColor );
  ...
  private void createDotControls( Composite parent, Color backgroundColor )
  {
    ...
    group.setText( "Dot" );
    this.dotSpacing = createDimensionBuilder( group, "Spacing:", backgroundColor, DotbarItem.DOT_SPACING_PROP );
    this.dotWidth = createDimensionBuilder( group, "Width:", backgroundColor, DotbarItem.DOT_WIDTH_PROP );
    createBorder( group, backgroundColor );
    this.dotShape = createRadioGroup( group, "Shape:", DotShape.getNames(), backgroundColor );
    {
      GridData gridData = new GridData();
      // gridData.horizontalSpan = 5;
      this.dotShape.setLayoutData( gridData );
    }
    this.dotHeight = createDimensionBuilder( group, "Height:", backgroundColor, DotbarItem.DOT_HEIGHT_PROP );
    createFill( group, backgroundColor );
  }

  private void createBorder( final Composite parent, final Color backgroundColor )
  {
  ...
  private RadioGroup createRadioGroup( Composite composite, String labelText, String[] buttonLabels, Color backgroundColor )
  {
  ...
  private void addModifyListener( final DimensionControl control, final ControlEventHandler handler, final String prop )
  {
  ...
  private void addSelectionListener( final Button button, final ControlEventHandler handler, final String prop )
  {
  ...
  private void setRadioListener( final RadioGroup radioGroup, final ControlEventHandler handler, final String prop )
  {
  ...
  private DimensionControl createDimensionBuilder( final Composite parent, final String labelText, final Color backgroundColor, final String propName )
  {
    createLabel( parent, labelText, backgroundColor );
    final DimensionControl builder = new DimensionControl( parent, SWT.None, DotbarItem.EXTENSION_NAME, propName );
    final GridData gridData = new GridData();
    builder.setLayoutData( gridData );
    return builder;
  }

  private IntegerControl createIntegerControl( final Composite parent, final String labelText, final Color backgroundColor )
  {
    createLabel( parent, labelText, backgroundColor );
  ...
  private Button createCheckbox( final Composite parent, final Color backgroundColor )
  {
  ...
  {
    void update( DotbarItem dotbarItem, ControlGroup controlGroup ) throws SemanticException;
  }
  ...
  static
  {
    ...
    UPDATERS.put( DotbarItem.VALUE_EXPRESSION_PROP, new Updater()
      {
        public void update( final DotbarItem dotbarItem, final ControlGroup controlGroup ) throws SemanticException
        {
          dotbarItem.setValueExpression( controlGroup.getValueExpression() );
        }
      } );
  ...
  public void updateModel( final DotbarItem dotbarItem, final String propName ) throws SemanticException
  {
